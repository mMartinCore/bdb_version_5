...
<br><br> <br>
          ...
          <div class="form-group col-sm-3">
            ...
            <div class="form-group  col-sm-6 {{$errors->has('station_id') ? 'has-error' :''}}">
                ...
                <hr> 
                <div class="form-group col-sm-12" >
                  <label for="exampleFormControlTextarea1">Case Summary <small class="mb-4px">Here you are required to enter the summary of the case.</small></label><small id="Error_summary"></small>
                  <textarea  id="summary" name="summary" class="form-control summary"   rows="7"></textarea>
                </div>
...
<div class="form-group col-sm-3">
    ...
    <div class="form-group col-sm-12 col-lg-12">
        ...
        <textarea class="form-control cause_of_Death" id="cause_of_Death" name="cause_of_Death"  cols="120" rows="4">
         </textarea>
    </div>
...
{!! Form::text('volume_no',null, [ 'placeholder'=>"132:19",'class' => 'form-control volume_no','id'=>'volume_no']) !!}
</div>
...
{!! Form::date('dna_result_date', null, [ 'class' => 'form-control dna_result_date','id'=>'dna_result_date']) !!}
</div>
...
{!! Form::textarea('dna_result', null,  [ 'rows'=> 4, 'class' => 'form-control dna_result','id'=>'dna_result']) !!}
...
<div class="form-group col-sm-4">
    {!! Form::label('pauper_burial_requested', 'Pauper\'s Burial Request:') !!}<small id="Error_pauper_burial_requested"></small>
...
//////// THIS MOVOVES FROM I.O SECTION TO MORGUE SECTION
      ...
      $("#MorgueSection").click(function(e){/// MOVE TO MORGUE SECTION
         e.preventDefault();
            ...
            if( station_id == true && summary == true && contact_no == true &&  assign_date == true &&
      ...
      $("#confirm").click(function(e){
         e.preventDefault();
            ...
            isBuried();
            burialDate(); 
            console.log(finger_print_date+"   "+ dna_result+"   "+ dna_result_date+"   "+ volume_no +"   "+  dna
+" "+dna_date+"   "+ finger_print+"   "+gazetted+"   "+ gazetted_date+"   "+pauper_burial_requested + buried+"   "+ burial_date);
            if ( finger_print_date == true && dna_result==true && dna_result_date==true && volume_no ==true &&  dna== true && dna_date==true && finger_print == true &&gazetted == true && gazetted_date == true &&pauper_burial_requested  == true &&
            buried == true && burial_date==true ) {
